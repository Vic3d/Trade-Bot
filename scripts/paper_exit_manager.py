...
TRANCHE1_TARGET_PCT = 0.05   # +5%  → exit tranche 1 (Reverted 2026-04-30 from +3% nach R:R-Analyse)
TRANCHE2_TARGET_PCT = 0.10   # +10% → exit tranche 2 (Reverted 2026-04-30 from +8%)
