...
THEME_TICKER_MAP = {
    ...
    # Phase 26 (Erichsen 17/2026 inspiriert) — neue Themen
    'power_grid':[('SE.DE',  'Siemens AG'),
                  ('ENR.DE', 'Siemens Energy'),
                  ('PRY.MI', 'Prysmian — Power Cables'),
                  ('NEXT.PA','Nexans — Cables'),
                  ('NKT.CO', 'NKT A/S — High-Voltage Cables')],
    'precious_streamer':[('WPM',   'Wheaton Precious Metals'),
                         ('FNV',   'Franco-Nevada'),
                         ('RGLD',  'Royal Gold'),
                         ('OR.TO', 'Osisko Gold Royalties')],
    'india_growth':[('IBN', 'ICICI Bank — India Banking'),
                    ('INFY','Infosys — IT Services'),
                    ('HDB', 'HDFC Bank'),
                    ('WIT', 'Wipro — IT Services')],
    'quantum':   [('IONQ', 'IonQ — Quantum'),
                  ('RGTI', 'Rigetti — Quantum'),
                  ('QBTS', 'D-Wave Quantum')],
    'data_center':[('VRT',  'Vertiv — Cooling/Power'),
                   ('DLR',  'Digital Realty — Data Center REIT'),
                   ('EQIX', 'Equinix — Data Center REIT'),
                   ('VST',  'Vistra — AI Power')],
    'obesity_drugs':[('LLY', 'Eli Lilly — Mounjaro/Zepbound'),
                     ('NVO', 'Novo Nordisk — Ozempic/Wegovy'),
                     ('AMGN','Amgen — MariTide')],
    'food_security':[('CF',  'CF Industries — Fertilizer'),
                     ('NTR', 'Nutrien — Fertilizer'),
                     ('MOS', 'Mosaic — Phosphate'),
                     ('DE',  'John Deere — AgTech')],
    'space':     [('RKLB', 'Rocket Lab'),
                  ('LMT',  'Lockheed Martin — Defense Space'),
                  ('PL',   'Planet Labs')],
    'oil_services':[('SLB',  'Schlumberger'),
                    ('HAL',  'Halliburton'),
                    ('BKR',  'Baker Hughes')],
}
